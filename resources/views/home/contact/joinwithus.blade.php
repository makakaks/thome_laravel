    ...
    <head>
        ...
        <style>
            * {
            ...
            /* Join Us Section */
>>>>>>> 36de096c0275adda709ee0e2fe5e32cdb626f022
            .join-us-container {
                display: flex;
                align-items: center;
                justify-content: space-between;
                ...
                <form id="jobApplicationForm">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="coverLetter" name="coverLetter" rows="5"
                            placeholder="เล่าเกี่ยวกับตัวคุณและเหตุผลที่สนใจตำแหน่งนี้... / Tell us about yourself and why you're interested in this position..."></textarea>
                    </div>
...
=======
        ...
        <div id="successMessage" class="success-message">
            <div class="success-content">
                ...
                <p>ขอบคุณที่สนใจ เราจะตรวจสอบใบสมัครของคุณและติดต่อกลับโดยเร็ว / Thank you for your interest. We will review
                    your application and get back to you soon.</p>
...
=======
        ...
        <div id="errorMessage" class="error-message">
            <div class="error-content">
                ...
                <p id="errorText">เกิดข้อผิดพลาดในการส่งใบสมัคร กรุณาลองใหม่อีกครั้ง / There was an error submitting your
                    application. Please try again.</p>
...
Please contact the applicant at ${data.email} or ${data.phone} for further communication.
                ...
                emailjs.send('Thome', 'template_shjqlbp', templateParams)
                    .then(function(response) {
                        ...
                        resetSubmitButton()
                        showError(
                            `เกิดข้อผิดพลาดในการส่งอีเมล: ${error.text || error.message || 'Unknown error'} / Email sending failed: ${error.text || error.message || 'Unknown error'}`
                            )
                    });
            })
