...
const slidesPerView = window.innerWidth > 768 ? 3 : window.innerWidth > 576 ? 2 : 1
...
function moveSlide(direction) {
  currentSlide = Math.max(0, Math.min(currentSlide + direction, totalSlides - slidesPerView))
...
document.querySelector(".btn-review").addEventListener("click", () => {
  window.open("https://www.facebook.com/t.homeinspector/reviews?locale=th_TH", "_blank")
...
window.addEventListener("resize", () => {
  const newSlidesPerView = window.innerWidth > 768 ? 3 : window.innerWidth > 576 ? 2 : 1
