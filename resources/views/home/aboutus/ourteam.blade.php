        ...
        <section class="department-section" data-department="executive">
            ...
            <div class="team-grid">
                ...
                <div class="team-card" data-id="3">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=วิชัย" alt="วิชัย รักษ์ไทย">
                        <div class="card-image-content">
                            <span class="department-badge">ผู้บริหาร</span>
        ...
        <section class="department-section" data-department="marketing">
            ...
            <div class="team-grid">
                ...
                <div class="team-card" data-id="5">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=ธนกร" alt="ธนกร กิจเจริญ">
                        <div class="card-image-content">
                            <span class="department-badge">การตลาด</span>
                            <h3>ธนกร กิจเจริญ</h3>
                ...
                <div class="team-card" data-id="6">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=จิราภา" alt="จิราภา พัฒนาดี">
                        <div class="card-image-content">
                            <span class="department-badge">การตลาด</span>
        ...
        <section class="department-section" data-department="technology">
            ...
            <div class="team-grid">
                <div class="team-card" data-id="7">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=ภาณุพงศ์" alt="ภาณุพงศ์ ทองดี">
                        <div class="card-image-content">
                ...
                <div class="team-card" data-id="8">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=อรุณี" alt="อรุณี มั่นคง">
                        <div class="card-image-content">
                            <span class="department-badge">เทคโนโลยี</span>
                            <h3>อรุณี มั่นคง</h3>
                            <p>หัวหน้านักพัฒนา</p>
                ...
                <div class="team-card" data-id="10">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=สุภาพร" alt="สุภาพร ใจดี">
                        <div class="card-image-content">
                            <span class="department-badge">เทคโนโลยี</span>
                            <h3>สุภาพร ใจดี</h3>
                            <p>วิศวกร QA</p>
        ...
        <section class="department-section" data-department="customer-service">
            ...
            <div class="team-grid">
                <div class="team-card" data-id="11">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=ดนัย" alt="ดนัย ธรรมรักษ์">
                        <div class="card-image-content">
                ...
                <div class="team-card" data-id="13">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=รัชพล" alt="รัชพล การุณย์">
                        <div class="card-image-content">
                            <span class="department-badge">บริการลูกค้า</span>
                            <h3>รัชพล การุณย์</h3>
        ...
        <section class="department-section" data-department="sales">
            ...
            <div class="team-grid">
                <div class="team-card" data-id="14">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=ลลิตา" alt="ลลิตา จันทร์เรือง">
                        <div class="card-image-content">
                ...
                <div class="team-card" data-id="15">
                    <div class="card-image">
                        <div class="image-overlay"></div>
                        <img src="https://via.placeholder.com/300x400/1a75ff/ffffff?text=ธีรพงษ์" alt="ธีรพงษ์ บุญมา">
                        <div class="card-image-content">
                            <span class="department-badge">ฝ่ายขาย</span>
                            <h3>ธีรพงษ์ บุญมา</h3>
