...
@section('content')
    ...
    <main>
        <div class="art-header">
            <h1 class="art-name">สรุป!! จักรวาลการออกแบบสาย LAN ตามบ้าน</h1>
        ...
        <div class="art-body">
            <div class="art-content">
                <p>
                    <span style="font-size: 18px">สรุปจักรวาลการออกแบบสาย LAN ตามบ้านแบบเข้าใจง่าย
                        โดยหลักการออกแบบเบื้องต้นจะมี 4 แบบดังนี้ (หรืออ่านในรูปได้ค่ะ)</span>
                </p>
                <p>
                    <span style="font-size: 18px"><img src="https://thomeinspector1.netlify.app/img/article1.jpg"
                            alt="Fiber Optic Design 1" class="sub-image" /></span>
                </p>
                <p>
                    <span style="font-size: 18px">1. มีจุดต่อ Fiber Optic อยู่ใกล้หม้อแปลงไฟฟ้า
                        มีการเชื่อมต่อไปที่โถงชั้น 1
                        และโถงชั้น 2 (รูปที่ 1) การเชื่อมระบบ LAN แบบส่วนตัว เน้นให้ใช้งานผ่าน Wifi
                        เป็นหลัก ไม่ได้เน้นการต่อสาย LAN เข้าทีคอมพิวเตอร์โดยตรง</span>
                </p>
                <p>
                ...
                <p>
                    <span style="font-size: 18px">2. มีจุดต่อ Fiber Optic อยู่ใกล้หม้อแปลงไฟฟ้า
                        มีการเชื่อมต่อไปที่โถงชั้น 1
                        และโถงชั้น 2 และห้องนอนส่วนตัวของบ้าน การเชื่อมระบบ LAN
                        รูปแบบแบ่งแยกเหมาะสมในรูปแบบส่วนตัวใช้ LAN สำหรับห้อง Computer
                        ในแต่ละห้อง</span>
                </p>
                <p>
                    <span style="font-size: 18px"><img src="https://thomeinspector1.netlify.app/img/article1.jpg"
                ...
                <p>
                    <span style="font-size: 18px">3. มีจุดต่อ Fiber Optic อยู่ใกล้หม้อแปลงไฟฟ้า
                        มีการเชื่อมต่อไปที่โถงชั้น 1
                        และโถงชั้น 2 และห้องนอนส่วนตัวของบ้าน การเชื่อมระบบ LAN
                        รูปแบบแบ่งแยกเหมาะสมในรูปแบบส่วนตัวใช้ LAN สำหรับห้อง Computer
                        ในแต่ละห้อง</span>
                ...
                <p>
                    <span style="font-size: 18px">4. มีจุดต่อ Fiber Optic อยู่ใกล้หม้อแปลงไฟฟ้า
                        มีการเชื่อมต่อไปที่โถงชั้น 1
                        และโถงชั้น 2 และห้องนอนส่วนตัวของบ้าน การเชื่อมระบบ LAN
                        รูปแบบแบ่งแยกเหมาะสมในรูปแบบส่วนตัวใช้ LAN สำหรับห้อง Computer
                        ในแต่ละห้อง</span>
